function MathEditor(id) {
    ...
    this.default_toolbar_buttons = [
        ...
        // Geometry
        'angle', 'triangle', 'parallel_to', 'perpendicular', 'parallelogram',
        ...
        'definite_integral', 'partial_derivative', 'double_integral',
        'nabla', 'laplacian',
        'sum_limits', 'product', 'product_limits',

        // Brackets
        'round_brackets', 'curly_brackets', 'absolute_value',
        'floor_brackets', 'ceil_brackets', 'angle_brackets',
        ...
        'logical_iff', 'logical_forall', 'logical_exists', 'logical_not_exists',
        'logical_therefore', 'logical_because',
        'logical_xor', 'logical_nand', 'logical_nor',

        // Matrices
        'matrix_2x2', 'matrix_3x3', 'matrix_2x1', 'matrix_1x2',
        'determinant', 'transpose', 'inverse',

        // Number theory
        'divides', 'not_divides', 'modulo',
        'gcd', 'lcm',
    ...
    button_meta = {
        ...
        "sum": {
            latex: "\\sum",
            tab: 4, icon: '\\sum_{\\square}^{\\square}\\square'
        },
        "sum_limits": {
            latex: "\\sum_{}^{}",
        ...
        "product": {
            latex: "\\prod",
            tab: 4, icon: '\\prod_{\\square}^{\\square}\\square'
        },
        "product_limits": {
            latex: "\\prod_{}^{}",
            moveto: "Left", movefor: 2, tab: 4,
        ...
        "log": {
            ...
            tab: 4, icon: '\\log\\left(\\square\\right)'
        },
        ...
        "complement": { latex: "\\complement", tab: 6, icon: '\\complement' },
        "set_difference": { latex: "\\setminus", tab: 6, icon: '\\setminus' },
        "cartesian_product": { latex: "\\times", tab: 6, icon: 'A\\times B' },
        "natural_numbers": { latex: "\\mathbb{N}", tab: 6, icon: '\\mathbb{N}' },
        "integers": { latex: "\\mathbb{Z}", tab: 6, icon: '\\mathbb{Z}' },
        "rationals": { latex: "\\mathbb{Q}", tab: 6, icon: '\\mathbb{Q}' },
        "reals": { latex: "\\mathbb{R}", tab: 6, icon: '\\mathbb{R}' },
        "complex_numbers": { latex: "\\mathbb{C}", tab: 6, icon: '\\mathbb{C}' },
        ...
        "logical_nand": { latex: "\\uparrow", tab: 9, icon: '\\uparrow' },
        "logical_nor": { latex: "\\downarrow", tab: 9, icon: '\\downarrow' },
        "divides": { latex: "\\mid", tab: 9, icon: '\\mid' },
        "not_divides": { latex: "\\nmid", tab: 9, icon: '\\nmid' },
        "modulo": {
            latex: "\\mod{}",
            moveto: "Left", movefor: 1, tab: 9,
            icon: '\\square\\mod\\square'
        },
        "gcd": {
            latex: "\\gcd\\left(,\\right)",
            moveto: "Left", movefor: 2, tab: 9,
            icon: '\\gcd(\\square,\\square)'
        },
        "lcm": {
            latex: "\\text{lcm}\\left(,\\right)",
            moveto: "Left", movefor: 2, tab: 9,
            icon: '\\text{lcm}(\\square,\\square)'
        },

        // ── TAB 10: Matrices ────────────────────────────────────────
        "matrix_2x2": {
            latex: "\\begin{pmatrix}{}&{}\\\\{}&{}\\end{pmatrix}",
            moveto: "Left", movefor: 3, tab: 10,
            icon: '\\begin{pmatrix}a&b\\\\c&d\\end{pmatrix}'
        },
        "matrix_3x3": {
            latex: "\\begin{pmatrix}{}&{}&{}\\\\{}&{}&{}\\\\{}&{}&{}\\end{pmatrix}",
            moveto: "Left", movefor: 8, tab: 10,
            icon: '\\begin{pmatrix}a&b&c\\\\d&e&f\\\\g&h&i\\end{pmatrix}'
        },
        "matrix_2x1": {
            latex: "\\begin{pmatrix}{}\\\\{}\\end{pmatrix}",
            moveto: "Left", movefor: 1, tab: 10,
            icon: '\\begin{pmatrix}a\\\\b\\end{pmatrix}'
        },
        "matrix_1x2": {
            latex: "\\begin{pmatrix}{}&{}\\end{pmatrix}",
            moveto: "Left", movefor: 1, tab: 10,
...
basicStyling = function (answer_span, top_elements) {
    ...
    top_elements.toolbar.css('min-width', answerSpanWidth);
};
